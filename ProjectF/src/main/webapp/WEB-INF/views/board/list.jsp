...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
	...
	<%@ include file="../includes/header.jsp" %>
		...
		<!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">자유게시판</h1><br />
       
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="line-height:2rem">자유게시판
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6440aa908fe5ec865e69f0edf2486cce">
