        ...
        $(document).ready(function(){
        	...
        	function makeList(result){
        		...
        		for(let i = 0; i < result.length; i++){
        			...
        			*/
        			str += "<button type='button' class='btn btn-warning replyBtn' data-rno='"+result[i].rno+"' data-service='modify'>수정</button>";
        			str += "<button type='button' class='btn btn-danger replyBtn' data-rno='"+result[i].rno+"' data-service='delete'>삭제</button>";
        			str += "</div></div>";
        		}
